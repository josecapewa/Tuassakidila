...
<body id="page-top">
	<div id="wrapper">
		<nav class="navbar align-items-start sidebar sidebar-dark accordion bg-gradient-primary p-0 navbar-dark" style="color: rgb(20,200,138);background: #027d51;">
			<div class="container-fluid d-flex flex-column p-0 mt-5"><a class="navbar-brand d-flex justify-content-center align-items-center sidebar-brand m-0" href="#">
					<div>
						<div><img src="assets/img/Imagem WhatsApp 2024-10-24 às 14.22.21_f50ecfa6.jpg" width="75" height="75"></div><br>
						<div class="sidebar-brand-text mx-3"><span>Tuassakidila</span></div><br>
					</div>
				</a>
